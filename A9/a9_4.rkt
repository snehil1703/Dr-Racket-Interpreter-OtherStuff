...
(define value-of-cps
  (lambda (exp env k)
    (union-case exp expr
      ...
      [(mult nexp1 nexp2) (value-of-cps nexp2 env (kt_*-outer-k nexp1 env k))]
      ...
      [(capture body) (value-of-cps body (envr_extend-env k env) 
                                                 k)]
      [(return kexp vexp) (value-of-cps kexp env (kt_return-k vexp env))]
...
(define apply-k
  (lambda (k v)
    (union-case k kt
      ...
      [(*-outer-k x1^ env^ k^) (value-of-cps x1^ env^ (kt_*-inner-k v k^))]
