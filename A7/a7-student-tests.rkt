    ...
    (parameterize ((read-accept-reader #t)
      ...
      (let ((sandboxed-eval
             (make-module-evaluator (read (open-input-file file))
                                    ;; #:allow-for-require '("parenthec.rkt")
                                    )))
  ...
  (test-suite "a7"
    ...
    (test-suite "lex" 
      (test-equal-if-defined lex
        ...
        ((lex '(capture k 5) '()) '(capture (const 5)))
        ((lex '(capture k (return k 5)) '()) '(capture (return (var 0) (const 5))))
        ((lex '(capture k (return k (* 5 5))) '()) '(capture (return (var 0) (mult (const 5) (const 5)))))
        ((lex '(capture k (return k (((lambda (x) x) k) (* 5 5)))) '()) 
         '(capture
           (return
            (var 0)
            (app (app (lambda (var 0)) (var 0)) (mult (const 5) (const 5))))))
        ((lex '(capture k (sub1 (return k 5))) '()) '(capture (sub1 (return (var 0) (const 5)))))
        ((lex '(capture k (return (return k 5) 6)) '()) 
         '(capture (return (return (var 0) (const 5)) (const 6))))
        ((lex '(capture k (return 5 (return k 5))) '())
         '(capture (return (const 5) (return (var 0) (const 5)))))
        ((lex '(* 3 (capture k (return 5 (return k 5)))) '())
         '(mult (const 3) (capture (return (const 5) (return (var 0) (const 5))))))
        ((lex '(lambda (a)
                 (lambda (b)
                   (lambda (c)
                     (lambda (a)
    ...
    (test-suite "value-of-cps"
      (test-equal-if-defined value-of-cps
        ...
        ((value-of-cps '(capture (const 5)) (empty-env) (empty-k)) 5)
        ((value-of-cps '(capture (return (var 0) (const 5))) (empty-env) (empty-k)) 5)
        ((value-of-cps '(capture (return (var 0) (mult (const 5) (const 5)))) (empty-env) (empty-k)) 25)
        ((value-of-cps '(capture (return (app (lambda (var 0)) (var 0)) (mult (const 5) (const 5)))) (empty-env) (empty-k)) 25)
        ((value-of-cps '(capture (sub1 (return (var 0) (const 5)))) (empty-env) (empty-k)) 5)
        ((value-of-cps '(capture (return (return (var 0) (const 5)) (const 6))) (empty-env) (empty-k)) 5)
        ((value-of-cps '(capture (return (const 5) (return (var 0) (const 5)))) (empty-env) (empty-k)) 5)
        ((value-of-cps '(mult (const 3) (capture (return (const 5) (return (var 0) (const 5))))) (empty-env) (empty-k)) 15)
