  ...
  (test-suite "a8"
    ...
    (test-suite "fib-ramp-driver"
      (test-equal-if-defined fib-ramp-driver
        ((fib-ramp-driver 5 -1 -1) 5)
        ((fib-ramp-driver -1 5 -1) 5)
        ((fib-ramp-driver -1 -1 5) 5)))
    (test-suite "fib-tramp-driver"
      (test-equal-if-defined fib-tramp-driver
        ((fib-tramp-driver 3 4) '(3 5))
	((fib-tramp-driver 4 3) '(3 5))
	((fib-tramp-driver 6 6) '(13 13))))))
