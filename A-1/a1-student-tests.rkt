...
(define tests
  (test-suite "A1:"
   ...
   (test-suite "count-?s"
     (test-equal-if-defined count-?s
       [(count-?s '(? y z ? ?)) 3]))

   (test-suite "count-?s-fr"   
     (test-equal-if-defined count-?s-fr
       [(count-?s-fr '(? y z ? ?)) 3]))
   ...
   (test-suite "zip-fr"   
     (test-equal-if-defined zip-fr
       [(zip-fr '(1 2 3) '(a b c)) '((1 . a) (2 . b) (3 . c))]
       [(zip-fr '(1 2 3 4 5) '(a b c)) '((1 . a) (2 . b) (3 . c))]
       [(zip-fr '(1 2 3) '(a b c d e)) '((1 . a) (2 . b) (3 . c))]))
